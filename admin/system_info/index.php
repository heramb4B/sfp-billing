	...
	<div class="card card-outline rounded-0 card-maroon">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="tax_rate" class="control-label">CGST Rate (%)</label>
					<input type="text" class="form-control form-control-sm" name="cgst_rate" id="tax_rate" value="<?php echo  $_settings->info('tax_rate') ?>">
				</div>
				<div class="form-group">
					<label for="tax_rate" class="control-label">SGST Rate (%)</label>
					<input type="text" class="form-control form-control-sm" name="sgst_rate" id="tax_rate" value="<?php echo  $_settings->info('tax_rate') ?>">
				</div>
			<div class="form-group">
